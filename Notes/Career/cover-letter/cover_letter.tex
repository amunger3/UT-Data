...
% CONTACT INFORMATION
%====================
\def\name{Alex Munger} % Name Here
\signature{\name}
\address{8453 Standifer Gap Rd., \\
Chattanooga, TN \\
37421}
\def\phone{(404) 574-8533}
\def\email{munger.alex@gmail.com}
\def\LinkedIn{alex-munger} % linkedin.com/in/______
\def\github{amunger3} % github username
\def\role{Data Analyst} % JOB TITLE

%====================
% Company Info
%====================
\def\hm{Galen Medical Group} % Hiring Manager Name, leave empty if unknown
\def\position{Data Analyst} % position
\def\company{Galen Medical Group} % company
\def\source{on ZipRecruiter} % where was the posting found, "I found ____ "
