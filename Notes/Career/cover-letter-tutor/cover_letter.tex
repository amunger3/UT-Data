...
% Company Info
%====================
\def\hm{Cleveland State Community College} % Hiring Manager Name, leave empty if unknown
\def\position{Tutor} % position
\def\company{Cleveland State Community College} % company
